...
setup(name='pyxai',
      ...
      install_requires=['lxml', 'numpy', 'wheel', 'pandas', 'termcolor', 'shap', 'wordfreq', 'python-sat[pblib,aiger]',
                        'xgboost==1.7.3', 'pycsp3', 'matplotlib', 'dill', 'lightgbm', 'docplex', 'ortools',
                        'packaging'],
      extras_require={
          "gui": ['pyqt6'],
      },
      ...
      ext_modules=[Extension(
          ...
          ["pyxai/sources/solvers/GREEDY/src/bt_wrapper.cc", "pyxai/sources/solvers/GREEDY/src/Explainer.cc",
           ...
           "pyxai/sources/solvers/GREEDY/src/Rectifier.cc"
           ],
          language="c++",
